...
--function body
  ...
  elseif IsButtonBeingPressed(1,0) then
    ...
    elseif PedIsPlaying(gPlayer, "/Global/Actions/Grapples/Front/Grapples/Hold_Idle", "Act/Globals.act", true) then
      PedSetActionNode(gPlayer, "/Global/Actions/Grapples/Front/Grapples/GrappleMoves/BodySlam/Give", "Act/Globals.act")
    else
  ...
  elseif IsButtonPressed(3,0) then
    PedSetActionNode(gPlayer, "/Global/B_Striker_A/Offense/Short/Strikes/LightAttacks", "Act/Anim/B_Striker_A.act")
  end
end
  ...
  --     PedSetActionNode(gPlayer, "/Global/G_Striker_A/Offense/Short/Strikes/HeavyAttacks/HeavyKnee", "act/anim/G_Striker_A.act")
  --   --O + Down Arrow
